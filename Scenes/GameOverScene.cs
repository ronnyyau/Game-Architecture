...
namespace OpenGL_Game.Scenes
{
    class GameOverScene : Scene
    {
        ...
        public override void Render(FrameEventArgs e)
        {
            ...
            GUI.Label(new Rectangle(0, 0, (int)width, (int)(fontSize * 2f)), "GameOver", (int)fontSize, StringAlignment.Center);
            ...
            GUI.Label(new Rectangle(0, 800, (int)width, (int)(fontSize * 0.4f)), "Press ESC to Exit", 30, StringAlignment.Center, Color.DarkOrange);
